...
const NODE_TYPE = "MiniMaxH3EasyAreaSwitch";
...
app.registerExtension({
    name: "minimax_h3_easy.area_switch",

    setup() {
        if (!globalThis.__minimaxH3AreaSwitchTimer) {
            globalThis.__minimaxH3AreaSwitchTimer = setInterval(
                syncAllRouteNodes,
                SYNC_INTERVAL_MS,
            );
        }
