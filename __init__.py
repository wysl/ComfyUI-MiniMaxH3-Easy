...
NODE_DISPLAY_NAME_MAPPINGS = {
    **FACE_REFINE_NODE_DISPLAY_NAME_MAPPINGS,
    ...
    "MiniMaxH3EasyLightroomLight": "MiniMax H3 Easy Lightroom Light",
    "MiniMaxH3EasyLightroomColor": "MiniMax H3 Easy Lightroom Color",
    "MiniMaxH3EasyLightroomDetail": "MiniMax H3 Easy Lightroom Detail",
    "MiniMaxH3EasyLightroomHSLWarm": "MiniMax H3 Easy Lightroom HSL Warm",
    "MiniMaxH3EasyLightroomHSLCool": "MiniMax H3 Easy Lightroom HSL Cool",
